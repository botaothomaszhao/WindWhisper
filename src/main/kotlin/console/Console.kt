package moe.tachyon.windwhisper.console
...
import moe.tachyon.windwhisper.console.Console.historyFile
import moe.tachyon.windwhisper.console.command.CommandSender
import moe.tachyon.windwhisper.console.command.LineParser
import moe.tachyon.windwhisper.console.command.ParsedLine
import moe.tachyon.windwhisper.dataDir
import moe.tachyon.windwhisper.logger.WindWhisperLogger
import moe.tachyon.windwhisper.logger.WindWhisperLogger.nativeOut
import moe.tachyon.windwhisper.utils.Power.shutdown
...
object Console
{
    private val logger = WindWhisperLogger.getLogger<Console>()
    /**
     * 终端对象
     */
