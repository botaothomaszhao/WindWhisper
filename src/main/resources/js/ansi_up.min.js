...
class AnsiUp {
    ...
    setup_palettes() {
        this.ansi_colors =
            [
                [
                    { rgb: [0x33, 0x33, 0x33], class_name: "ansi-black" },
                    { rgb: [0xed, 0xab, 0xab], class_name: "ansi-red" },
                    { rgb: [0xa4, 0xdf, 0xae], class_name: "ansi-green" },
                    { rgb: [0xee, 0xcf, 0xa0], class_name: "ansi-yellow" },
                    { rgb: [0x8f, 0xc7, 0xff], class_name: "ansi-blue" },
                    { rgb: [0xd2, 0xcc, 0xff], class_name: "ansi-magenta" },
                    { rgb: [0xa1, 0xe8, 0xe5], class_name: "ansi-cyan" },
                    { rgb: [0xf3, 0xf2, 0xf2], class_name: "ansi-white" },
                ],
                [
                    { rgb: [0x66, 0x66, 0x66], class_name: "ansi-bright-black" },
                    { rgb: [0xff, 0xc4, 0xc4], class_name: "ansi-bright-red" },
                    { rgb: [0xbd, 0xf8, 0xc7], class_name: "ansi-bright-green" },
                    { rgb: [0xff, 0xe8, 0xb9], class_name: "ansi-bright-yellow" },
                    { rgb: [0xa8, 0xe0, 0xff], class_name: "ansi-bright-blue" },
                    { rgb: [0xeb, 0xe5, 0xff], class_name: "ansi-bright-magenta" },
                    { rgb: [0xba, 0xff, 0xfe], class_name: "ansi-bright-cyan" },
                    { rgb: [0xff, 0xff, 0xff], class_name: "ansi-bright-white" },
                ]
            ];
        this.palette_256 = [];
